...
public class MoneyTrackerSqlInit extends SQLiteOpenHelper {
	...
	public static final int COLUMN_CATEGORYID = -1;
	public static final double COLUMN_AMOUNT = 0.0;
	...
	private static final String ENTRIES_CREATE = "create table "
			...
			+ " integer primary key autoincrement, " + COLUMN_CATEGORYID
			+ " int not null REFERENCES categories(_id) on UPDATE CASCADE, " + COLUMN_AMOUNT + "real not null);";
