...
public class CategoryDao {
	// Database fields
	  ...
	  public Category createCategory(String name) {
	    ...
	    long insertId = database.insert(MoneyTrackerSqlInit.TABLE_CATEGORIES, null,
	        values);
	    Cursor cursor = database.query(MoneyTrackerSqlInit.TABLE_CATEGORIES,
	        allColumns, MoneyTrackerSqlInit.COLUMN_ID + " = " + insertId, null,
	        null, null, null);
	    cursor.moveToFirst();
	  ...
	  public void deleteCategory(Category category) {
	    ...
	    database.delete(MoneyTrackerSqlInit.TABLE_CATEGORIES, MoneyTrackerSqlInit.COLUMN_ID
	        + " = " + id, null);
	  }
